...
type Message struct {
	...
	ToUser    int64          `gorm:"type:bigint;not null;column:to_user;index:idx_to_user_id,priority:1;index:idx_from_to,priority:2;index:idx_to_from,priority:1" json:"to_user"`
