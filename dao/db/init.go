...
func InitMySQL() {
	...
	pathRead := strings.Join([]string{mConfig.Username, ":", mConfig.Password, "@tcp(", mConfig.Addr, ")/", mConfig.Database, "?charset=" + mConfig.Charset + "&parseTime=true"}, "")
	pathWrite := strings.Join([]string{mConfig.Username, ":", mConfig.Password, "@tcp(", mConfig.Addr, ")/", mConfig.Database, "?charset=" + mConfig.Charset + "&parseTime=true"}, "")
